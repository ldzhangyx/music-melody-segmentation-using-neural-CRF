...
class CrossValidator:
    ...
    def compute(self):
        ...
        for j in range(self.epochs):
            ...
            name = "/gpfsnyu/scratch/yz6492/melody_seg/model/" +'lstmcrf_binary_aug_{}_train_epoch'.format(self.augment_data_flag) + str(j)+ '.pt'
...
print('I am in! this is lstmcrf binary')
...
out_f = open("/gpfsnyu/home/yz6492/melody_seg/data/essen_lstmcrf_binary_report.pkl", "wb")
