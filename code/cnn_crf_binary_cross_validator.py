...
class CrossValidator:
    ...
    def compute(self):
        ...
        self.val_X, self.val_Y = training_set_factorize(tempval_X, tempval_Y, augment_data=self.augment_data_flag)
        ...
        for j in range(self.epochs):
            ...
            name = 'cnncrf_binary_train_epoch' + str(j)+ str(self.augment_data_flag) + '.pt'
...
sys.stdout.flush()
validator = CrossValidator(model, compute_acc=compute_acc, partition = 1, batch_size=BATCH_SIZE,
                           epochs=50, lr=1e-2, augment_data=False)
precision, recall, loss = validator.compute()
# print(precision, recall, loss)
out_f = open("/gpfsnyu/home/yz6492/melody_seg/data/essen_cnncrf_binary_report.pkl", "wb")
